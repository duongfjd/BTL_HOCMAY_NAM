...
# Load the models
models = {
    'linear': joblib.load('HOC_MAY_BTL/linear_regression_model.pkl'),
    'ridge': joblib.load('HOC_MAY_BTL/ridge_regression_model.pkl'),
    'nn': joblib.load('HOC_MAY_BTL/neural_network_model.pkl')
}
